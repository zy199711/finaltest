...
namespace trader
{
	...
	public class MdApi
	{
		const string strDllFile = @"Resources\MdApi.dll";

		/// <summary>
		/// MdApi.dll/CTPMdApi.dll/thostmduserapi.dll 放在主程序的执行文件夹中
		/// </summary>
		/// <param name="_investor">投资者帐号:9999</param>
		/// <param name="_pwd">密码</param>
		/// <param name="_broker">经纪公司代码:</param>
		/// <param name="_addr">前置地址:默认为CTP模拟</param>
		public MdApi(string _investor, string _pwd, string _broker = "9999"
			, string _addr = "tcp://180.168.146.187:10010")
		{
