...
namespace trader
{
	...
	{
		const string dllName = @"Resources\TradeApi.dll";

        /// <summary>
        /// TradeApi.dll/CTPTradeApi.dll/thosttraderapi.dll 放在主程序的执行文件夹中
        /// </summary>
        /// <param name="_investor">投资者帐号:114128</param>
        /// <param name="_pwd">密码:22446688</param>
        /// <param name="_broker">经纪公司代码:</param>
        /// <param name="_addr">前置地址:默认为CTP模拟</param>
        public TradeApi(string _investor, string _pwd, string _broker = "9999"
			, string _addr = "tcp://180.168.146.187:10000")
		{
		...
		[DllImport(dllName, EntryPoint = "?Connect@@YAHPAD@Z", CallingConvention = CallingConvention.Cdecl)]
		...
		public int ReqQryTransferBank(string Bank_ID = null, string BankBrch_ID = null)
		...
		/// <param name="Bank_ID"></param>
		/// <param name="BankBrch_ID"></param>
		public int ReqQryContractBank(string Bank_ID = null, string BankBrch_ID = null)
		{ return reqQryContractBank(this.BrokerID, Bank_ID, BankBrch_ID); }
